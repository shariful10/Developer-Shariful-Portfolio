...
const TestimonialCard = ({ item }) => {
	return (
		<div className="bg-navy transition duration-300 hover:bg-rose-600 px-4 py-8 md:p-10 rounded-lg mt-10 text-center">
			...
			<img
				...
				src="https://i.ibb.co/k1tYcPP/icons8-quote-left-100.png"
				alt=""
			/>
			<p>{item.desc}</p>
		</div>
